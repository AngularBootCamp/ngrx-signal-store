# Angular Boot Camp example: ngrx-signal-store
...
**[StackBlitz for ngrx-signal-store](https://stackblitz.io/github/AngularBootCamp/ngrx-signal-store)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/ngrx-signal-store.git
